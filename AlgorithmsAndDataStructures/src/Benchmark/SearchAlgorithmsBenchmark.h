#pragma once
#include "../Algorithms/SearchAlgorithms/LinearSearch.h"
#include "../Algorithms/SearchAlgorithms/BinarySearch.h"
#include "../Algorithms/SearchAlgorithms/JumpSearch.h"
#include "../Algorithms/SearchAlgorithms/InterpolationSearch.h"
