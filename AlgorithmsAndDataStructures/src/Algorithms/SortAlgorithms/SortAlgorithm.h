...
public:
	...
	virtual void SortVector(vector_iterator_int begin_it, vector_iterator_int end_it) = 0;
	virtual void SortVector(vector_iterator_big_obj begin_it, vector_iterator_big_obj end_it) = 0;
