...
#pragma endregion
	...
	RangePair range_ = std::make_pair(std::numeric_limits<GENERATED_TYPE>::min(), std::numeric_limits<GENERATED_TYPE>::max());

	double probability_ = 0.0;										//Binomial, Negative binomial, Geometric
	double mean_ = 0.0;												//Poisson, Normal
	double lambda_ = 0.0;											//Exponential
	...
	double stdev_ = 0.0;											//Normal
	std::pair<double, double> ms_parameters_{1.0, 1.0};				//LogNormal
	double degrees_of_freedom_ = 0.0;								//Chi squared, Student_t
